...
export default function LoanReport() {
  ...
  const total = loans.reduce((s, l) => s + Number(l.loan_amt || 0), 0)
    ...
    <div>
      ...
      <div className="table-box">
        <table>
          <thead>
            <tr>
              <th>Emp No</th><th>Name</th><th>Loan Amount</th><th>Installment</th><th>Interest</th><th>Total Deduction</th><th>Balance</th>
            </tr>
          </thead>
          <tbody>
            {loans.map((l, i) => (
